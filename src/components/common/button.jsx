...
const buttonVariant = cva("font-rubik", {
  variants: {
    variant: {
      ...
      secondary: "rounded-lg bg-[#070148] px-4 py-2 text-xs font-medium text-[#FFF] md:rounded-[14px] md:px-[60px] md:py-[30px] md:text-2xl hover:bg-[#0b026f] focus:ring-4 focus:outline-none focus:ring-[#93c5fd]"
    },
  },
});
