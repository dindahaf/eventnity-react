export function SideNavigation() {
  return (
    <>
      ...
      <aside
        id="default-sidebar"
        className="fixed top-[70px] md:top-[54px] left-0 z-40 w-60 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidenav"
      >
        ...
        <a
          ...
          className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer  hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600"
        >
          <svg
            aria-hidden="true"
            className="w-6 h-6"
